...
3. `docs/internal/stage12_test_acceptance.md`
4. `docs/internal/stage12_code_review_checklist.md`
5. `docs/internal/stage12_manual_test_cases.md`
...
| Stage 12 开发派工 | `stage12_deerflow_tool_dev_assignment.md`、`stage12_mcp_dev_assignment.md` |
| Stage 12 测试验收 | `stage12_test_acceptance.md`、`stage12_manual_test_cases.md`、`stage12_code_review_checklist.md` |
