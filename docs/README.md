...
3. `docs/internal/stage12_deerflow_tool_dev_assignment.md`
4. `docs/internal/stage12_3_deerflow_integration_plan.md`
5. `docs/internal/stage12_code_review_checklist.md`
6. `docs/delivery/deerflow_tool_integration_guide.md`
7. `docs/delivery/mcp_integration_guide.md`
8. `docs/delivery/patent_search_service_api_delivery_overview.md`
9. `docs/delivery/api_spec.md`
10. `docs/delivery/query_syntax.md`
11. `docs/delivery/field_mapping.md`
12. `docs/ops/deployment_runbook.md`
...
| `deerflow_tool_integration_guide.md` | DeerFlow Tool 本地封装、环境变量、smoke 和注册草案 |
| `mcp_integration_guide.md` | MCP stdio Server、本地 smoke、tools 清单和接入草案 |
...
| Stage 12.3 DeerFlow / Flow 联调 | `stage12_3_deerflow_integration_plan.md` |
